...
<img alt="Logo"
     src="{{ config('company.logo_path') ? Storage::url(config('company.logo_path')) : image('logos/default-dark.svg') }}"
     class="h-25px app-sidebar-logo-default" />

<img alt="Logo"
     src="{{ config('company.favicon_path') ? Storage::url(config('company.favicon_path')) : image('logos/default-small.svg') }}" {{-- Assuming favicon for small logo --}}
