...
Route::prefix('v1')->group(function () {
    ...
    // POST /api/v1/leads - LeadController@store
    // GET /api/v1/leads/{lead} - LeadController@show
    // PUT/PATCH /api/v1/leads/{lead} - LeadController@update
    // DELETE /api/v1/leads/{lead} - LeadController@destroy
});
